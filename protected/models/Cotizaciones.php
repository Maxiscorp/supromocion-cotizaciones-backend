...
class Cotizaciones extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idcotizacion, idarchivo_pdf, idcliente, idoperador, idcotizacion_estado, idmedio_pago, fecha_ingreso, fecha_vencimiento, fecha_recontacto, fecha_recontacto_recordatorio, recontactar, condiciones_contratacion, observaciones, activo', 'safe', 'on'=>'search'),
		);
	}
