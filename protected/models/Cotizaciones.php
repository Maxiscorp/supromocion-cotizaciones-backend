...
class Cotizaciones extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('fecha_ingreso, fecha_vencimiento, fecha_recontacto', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('idproducto_tipo,idcotizacion, idarchivo_pdf, idcliente, idoperador, idcotizacion_estado, idmedio_pago, fecha_ingreso, fecha_vencimiento, fecha_recontacto, recontactar, condiciones_contratacion, observaciones, activo', 'safe', 'on' => 'search'),
        );
    }
