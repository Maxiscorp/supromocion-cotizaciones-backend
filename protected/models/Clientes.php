 ...
 * @property integer $recontacar_cotizaciones
...
class Clientes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idarchivo_logo', 'required'),
			array('envia_mails_seguimiento, idarchivo_logo, recontacar_cotizaciones, activo', 'numerical', 'integerOnly'=>true),
			...
			array('idcliente, cuit, razon_social, nombre_comercial, contacto, email, telefono, envia_mails_seguimiento, localidad, codigo_postal, idcondicion_iva, idarchivo_logo, idprovincia, fecha_alta, fecha_ultima_cotizacion_aprobada, recontacar_cotizaciones, activo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('recontacar_cotizaciones',$this->recontacar_cotizaciones);
