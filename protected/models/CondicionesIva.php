...
/**
 * This is the model class for table "condiciones_iva".
 *
 * The followings are the available columns in table 'condiciones_iva':
 * @property integer $idcondicion_iva
...
class CondicionesIva extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idcondicion_iva, descripcion, activo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'clientes' => array(self::HAS_MANY, 'Clientes', 'idcondicion_iva'),
		);
	}
