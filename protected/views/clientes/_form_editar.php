...
<div class="form">
        ...
        <tr>
           <!-- <td class="coltitulos"><?php /*echo $form->labelEx($model, 'idarchivo_logo'); ?></td>
            <td>
                ...
                <div class="errores"><?php echo $form->error($model, 'logo'); */
				?></div>
            </td>-->
            <td colspan="2" class="coltitulos"><?php echo $form->labelEx($model, 'envia_mails_seguimiento'); ?></td>
            <td colspan="2">
    ...
    <table class="tablaagentesretencion">
        ...
        <tr>
            ...
            <td
                <input type="hidden" name="ClientesAgentesRetencionGanancias[activo]" value="0" />
